...
export const GlobalProvider = ({children})=>{
  ...
  const login = async (email,password)=>{
    ...
    try {
      ...
      // Return false so UI can handle failed login without needing to catch exceptions
      return false;
    }  finally{
      setLoading(false)
    }
  ...
  //register function
   const register = async (formData)=>{
    ...
    try {
      ...
      // Store the error message for the component to use
